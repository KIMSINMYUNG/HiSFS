...
namespace HiSFS.Api.Host.Migrations
{
    ...
    [Migration("20210601014328_2021060101")]
    partial class _2021060101
    {
            ...
            modelBuilder.Entity("HiSFS.Api.Shared.Models.발주서별품질검사장비", b =>
                {
                    ...
                    b.HasKey("발주번호", "검사장비식별번호");

                    b.HasIndex("검사장비식별번호");

                    b.HasIndex("회사코드");

                    b.HasIndex("발주번호", "품질검사코드");
            ...
            modelBuilder.Entity("HiSFS.Api.Shared.Models.발주서별품질검사장비", b =>
                {
                    ...
                    b.HasOne("HiSFS.Api.Shared.Models.발주서별품질검사정보", "검사정보")
                        .WithMany("발주서별품질검사장비목록")
                        .HasForeignKey("발주번호", "품질검사코드");
